    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">
          Le visite che hai schedulato per le stanze
        </p>
      </div>
      ...
      {bookings.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 text-lg">Nessun appuntamento</p>
          <p className="text-gray-400 text-sm mt-1">
            Quando scheduli una visita, apparirà qui
          </p>
        </div>
      ) : (
              ...
              >
                ...
                <div className="p-6 border-b border-gray-100">
                  <div className="flex justify-between items-start">
                    <div>
                      <Link href={`/stanza/${booking.listing.id}`} className="font-semibold text-gray-800 hover:text-primary-600 transition-colors">
